<script lang="ts">
import JavascriptIcon from '$components/icons/JavascriptIcon.svelte';
import NodeJsIcon from '$components/icons/NodeJsIcon.svelte';
import SvelteIcon from '$components/icons/SvelteIcon.svelte';
import TsconfigIcon from '$components/icons/TsconfigIcon.svelte';
import ViteIcon from '$components/icons/ViteIcon.svelte';
import {ChevronRightIcon, FolderIcon} from '@untitled-theme/icons-svelte';
import type {Component} from 'svelte';
import {createTreeCollection, type NodeProps, TreeView} from 'ui-ingredients';
