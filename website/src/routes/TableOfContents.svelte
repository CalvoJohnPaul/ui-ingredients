...
<aside
	class="fixed right-(--scrollbar-width,0) top-16 mt-20 hidden w-[20rem] shrink-0 border-l border-neutral-200 bg-white py-2 xl:block dark:border-neutral-800 dark:bg-neutral-950"
>
	...
	>
		{#each items as item}
			<SegmentGroup.Item
				value={item.id}
				class="ui-checked:text-neutral-800 dark:ui-checked:text-neutral-200 relative block cursor-pointer py-0.5 pl-(--indent) text-neutral-500 transition-colors duration-150 hover:text-neutral-600 dark:text-neutral-400 dark:hover:text-neutral-300"
